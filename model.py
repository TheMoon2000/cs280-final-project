...
class Uformer(nn.Module):
    def __init__(self, img_size=256, in_chans=3, dd_in=3,
                 ...
                 cross_modulator=False, out_channels=3, **kwargs):
        super().__init__()
        ...
        self.output_proj = OutputProj(in_channel=2*embed_dim, out_channel=out_channels, kernel_size=3, stride=1)
    ...
    def forward(self, x, mask=None):
        ...
        return x + y if self.dd_in == self.out_channels else y
